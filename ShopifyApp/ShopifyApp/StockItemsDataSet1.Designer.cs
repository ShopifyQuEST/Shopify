...
SELECT SalesID, SalesDate, TransactionID, CustomerID, SalesTotal FROM Sales WHERE (SalesID = @SalesID)";
    ...
    public partial class SalesHistoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[SalesHistory] ([SalesID], [ProductID], [UnitPrice], [Quantity]" +
                ", [Date], [TotalPrice]) VALUES (@SalesID, @ProductID, @UnitPrice, @Quantity, @Da" +
                "te, @TotalPrice)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
